    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onDismiss}>
      <View style={alarmModalStyles.modalOverlay}>
        <View style={alarmModalStyles.modalContent}>
          ...
          <Text style={alarmModalStyles.title}>{title || t("alarm.alarm")}</Text>
          <Text style={alarmModalStyles.message}>{message || t("alarm.timeToWork")}</Text>
          <Text style={alarmModalStyles.time}>{formatDate(new Date(), "full")}</Text>
          <Text style={alarmModalStyles.elapsedTime}>
            {t("alarm.displayTime")}: {formatElapsedTime()}
          </Text>

          <TouchableOpacity style={alarmModalStyles.dismissButton} onPress={onDismiss}>
            <Text style={alarmModalStyles.dismissButtonText}>{t("alarm.dismissAlarm")}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
