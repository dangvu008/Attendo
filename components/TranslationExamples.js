      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          <Trans i18nKey="home.welcomeMessage">
            Welcome to <StyledText>Workly</StyledText>, your personal shift
            management app!
          </Trans>
        </View>
        ...
        <View style={styles.card}>
          ...
          >
            Current weather:{" "}
            <StyledText style={styles.temperature}>
              {{ temperature }}&#176;C
            </StyledText>{" "}
        ...
        <View style={styles.card}>
          ...
          <Trans i18nKey="home.shiftInstructions">
            Tap <StyledText style={styles.buttonName}>Go to Work</StyledText> to
            start your shift, then use{" "}
            <StyledText style={styles.buttonName}>Check In</StyledText> when you
            arrive.
          </Trans>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Trans i18nKey="home.reminderNote" values={{ count: reminderCount }}>
            You have <StyledText style={styles.count}>{{ count }}</StyledText>{" "}
            reminder(s) scheduled for today.{" "}
            <TextLink onPress={() => navigation.navigate("Notes")}>
              View all
            </TextLink>
            .
          </Trans>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          ...
          <Trans i18nKey="shifts.shiftTip">
            For{" "}
            <StyledText style={styles.highlight}>overnight shifts</StyledText>,
            set the end time to be{" "}
        ...
        <View style={styles.card}>
          ...
          />
          <Trans
            i18nKey="shifts.breakExplanation"
            values={{ duration: breakDuration }}
          >
            A <StyledText style={styles.duration}>{{ duration }}</StyledText>{" "}
            minute break is{" "}
            <StyledText style={styles.highlight}>
              automatically deducted
            </StyledText>{" "}
            from your work hours.
          </Trans>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Trans i18nKey="home.helpText">
            Need help? Visit our{" "}
            <TextLink onPress={() => alert("Opening help center...")}>
              help center
            </TextLink>{" "}
            or contact{" "}
            <TextLink onPress={() => alert("Opening support...")}>
              support
            </TextLink>
            .
          </Trans>
